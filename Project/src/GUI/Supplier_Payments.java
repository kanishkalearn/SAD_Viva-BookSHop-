...
public class Supplier_Payments extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel.add(voucherDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 90, 200, 25));
        ...
        if (table.getColumnModel().getColumnCount() > 0) {
            ...
            table.getColumnModel().getColumn(5).setPreferredWidth(198);
        }
        ...
        panel.add(btn_Cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 650, 90, 30));
        ...
        panel.add(btn_Save, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 650, 90, 30));
                        ...
                        for (int i = 0; i < table.getRowCount(); i++) {
                            ...
                            double payAmount = Double.parseDouble(table.getValueAt(i, 5).toString());
                                ...
                                if (payAmount != 0) {
                                    ...
                                    DB.iud("UPDATE payble_grn SET paid_amount = paid_amount + '" + payAmount + "',balance='" + (Double.parseDouble(dtm.getValueAt(i, 3).toString()) - Double.parseDouble(dtm.getValueAt(i, 4).toString()) - payAmount) + "' WHERE grn_no = '" + dtm.getValueAt(i, 1).toString() + "' ");
                                }
    ...
    private void calculateTotal() {
        ...
        double v = 0;
        for (int i = 0; i < table.getRowCount(); i++) {
            v = v + Double.parseDouble(dtm.getValueAt(i, 5).toString());
        }
