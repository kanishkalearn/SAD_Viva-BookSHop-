...
public class EmployeeExcelReport {
    ...
    private static final String[] columnHeader = {"Employee Id", "First Name", "Middle Name", "Last Name", "Gender", "Date of Birth",
        "NIC", "Email", "Mobile", "Street", "City", "Active Status"};
    ...
    public static void writeExcel(String sheetName, String path) {
        ...
        try {
            ...
            try {
                ResultSet rs = DB.search("select * from employee"); //get data from database
